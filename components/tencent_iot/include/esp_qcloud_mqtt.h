...
extern "C"
{
    ...
    /**
     * @brief QCLOUD MQTT EVENT
     */
    ESP_EVENT_DECLARE_BASE(QCLOUD_MQTT_EVENT);

    typedef enum
    {
        QCLOUD_MQTT_EVENT_CONNECTED,        /**< QCloud MQTT Connected */
        QCLOUD_MQTT_EVENT_DISCONNECTED      /**< QCloud MQTT Disconnected */
    } esp_qcloud_mqtt_event_t;
     ...
     */
    typedef void (*esp_qcloud_mqtt_subscribe_cb_t)(const char *topic, void *payload, size_t payload_len, void *priv_data);

    /** Initialize ESP QCloud MQTT
     *
