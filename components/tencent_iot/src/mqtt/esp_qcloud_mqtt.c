...
ESP_EVENT_DEFINE_BASE(QCLOUD_MQTT_EVENT);
...
static esp_err_t mqtt_event_handler(esp_mqtt_event_handle_t event)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        /* Post event to application after reconnection */
        esp_event_post(QCLOUD_MQTT_EVENT, QCLOUD_MQTT_EVENT_CONNECTED, NULL, 0, portMAX_DELAY);
        break;

    case MQTT_EVENT_DISCONNECTED:
        ESP_LOGW(TAG, "MQTT Disconnected. Will try reconnecting in a while...");
        /* Post event to application when disconnected */
        esp_event_post(QCLOUD_MQTT_EVENT, QCLOUD_MQTT_EVENT_DISCONNECTED, NULL, 0, portMAX_DELAY);
        break;
