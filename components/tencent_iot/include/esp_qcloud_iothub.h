...
#define DYN_REG_SERVER_URL "http://ap-guangzhou.gateway.tencentdevices.com/register/dev" /**< URL for dynamic registering device */
#define DYN_REG_SIGN_LEN (64)
#define DYN_BUFF_DATA_MORE (10)
#define DYN_REG_RSP_BUFF_LEN (256)
#define DECODE_BUFF_LEN (256)
    ...
    /**
     * @brief ESP QCloud Device Profile.
     */
    typedef struct
    {
        char *product_id;
     ...
     *
     * @note Work within the dynamic register device mode.
     * @param[in] device_secret Device secret.
     * @return
     *     - ESP_OK: succeed
     *     - others: fail
     */
     ...
     */
    esp_qcloud_profile_t *esp_qcloud_get_device_profile(void);
    ...
    /**
     * @brief Start dynamic register device task.
     *        Constuct request parameters then send http post request to get device secret finally.
     *
     * @return
     *     - ESP_OK: succeed
     *     - others: fail
